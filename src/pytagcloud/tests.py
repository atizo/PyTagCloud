...
class Test(unittest.TestCase):
    ...
    def test_create_tag_image(self):
        ...
        start = time.time()
        create_tag_image(self.tags, os.path.join(home, 'cloud.png'), size=(300,400), background=(255,255,255), vertical=False, crop=False, fontname='fonts/Arial.ttf', fontzoom=3)
